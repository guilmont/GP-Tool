...
void Quad::generateObj(void)
{
    ...
    gl_call(glad_glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE,
    ...
    gl_call(glad_glBufferData(GL_ELEMENT_ARRAY_BUFFER,
                              vIndex.size() * sizeof(uint32_t),
...
void Quad::draw(void)
{
    ...
    gl_call(glad_glDrawElements(GL_TRIANGLES, vIndex.size(),
                                GL_UNSIGNED_INT, 0));
