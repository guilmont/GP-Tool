...
static MatXd GenTrajectories(uint32_t nFrames, const VecXd& par)
{
    ...
    std::lognormal_distribution<double> lognormal(log(par(Pmtr::PREC) + 1e-5), 0.05);
    ...
    addOcclusions(par(Pmtr::OCC), traj);
